...
const HomeSection = () => {
  return (
    <section className="fixed w-full h-screen bg-[#ececec] flex justify-center items-center pb-[10rem] z-1 m-auto ">
      <div className="flex flex-col items-center gap-7 ">
          ...
          <motion.h2
            ...
            className="tittle-font text-[95px] text-gray-900 cursor-pointer text-center"
          >
            Optimize your time,
            <br />
            create more.
        ...
        >
          <p className="normal-text text-center w-[60%] m-auto text-font">
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quidem
            iste, nulla veniam quia illum quod. Eligendi hic repudiandae saepe
            provident.
          </p>
        </motion.div>
        <motion.div
        ...
        >
          <Link href="/pages/about">
            <button className="bottons-color">
              Get Started
              <svg
